...
class BinaryTree
{
    public:
        ...
        bool isOrderedRecursiveHelp(Node * curr) const;
        ...
        void getPathsHelp(vector<vector<T> > &paths, vector<T> onePath, Node * curr) const;
        ...
        int sumDistancesHelp(const Node * curr, int total) const;
